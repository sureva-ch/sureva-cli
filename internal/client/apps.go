...
type CreateAppRequest struct {
	...
	// UseExistingRepo adopts a GitHub repository of the same name instead of
	// failing with a conflict. The repository is left untouched — no template is
	// committed to it.
	UseExistingRepo bool `json:"use_existing_repo,omitempty"`
}
